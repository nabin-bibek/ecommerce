      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg: col-span-2">
            <div className="mx-auto mt-24 bg-white max-w-7xl px-2 sm:px-4 lg:px-4">
              <div className="border-t border-gray-200 px-2 py-0 sm:px-2">
              ...
              <div className="border-t border-gray-200 px-4 py-6 mt-3 sm:px-6">
                <div className="flex justify-between my-2  text-base font-bold text-gray-900 ">
                  <p>Subtotal</p>
                  <p>$ {totalAmount}</p>
                </div>
